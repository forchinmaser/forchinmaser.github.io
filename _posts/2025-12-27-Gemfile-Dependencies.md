...
![Annotations Failed to save](/assets/img/20251226Annotation-Warnings.png){: width=50% height=50%}
![Deprecation You appear to have pagination turned on, but you haven't included the jekyll-paginate gem](/assets/img/20251226-Jekyll-yellow.png){: width=50% height=50%}
...
![Dependency Error Yikes! It looks like you don't have jekyll-paginate or one of its dependencies installed.](/assets/img/20251226-Jekyll-red.png){: width=50% height=50%}
...
![correct syntax for Gemfile and _config.yml](/assets/img/20251226Paginate-Syntax.png){: width=50% height=50%}
...
![List of build failures fuck fuck fuck](/assets/img/2025-12-27-build-failures.png){: width=50% height=50%}
...
![Create jekyll.yml](/assets/img/2025-12-27-create-jekyllyml.png){: width=50% height=50%}
